...
import { X, AlertTriangle, User, Calendar, IndianRupee, FileText, Upload, Save } from 'lucide-react';
...
const EditIncidentModal: React.FC<EditIncidentModalProps> = ({ 
  ...
  useEffect(() => {
    if (incident) {
      setFormData({
        ...
        dentistId: incident.dentistId,
        dentistName: incident.dentistName,
        cost: incident.cost,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedIncident: Incident = {
      ...
      ...formData,
      files,
      resolvedAt: formData.status === 'resolved' && !incident.resolvedAt 
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-xl">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Update incident details and information</p>
            </div>
          </div>
          <button
            onClick={handleClose}
